...
abstract class OssmTemplate {
    ...
    fun register() {
        IMC.registerAssemblerTemplate("prom_wipe", this::class.qualifiedName+".select", this::class.qualifiedName+".validate", this::class.qualifiedName+".assemble", host, containerTiers, upgradeTiers, componentSlots);
    }
