...
class OssmPromWipe {
	companion object {
		fun register() {
			IMC.registerAssemblerTemplate("prom_wipe", "net.shadowkat.minecraft.opensolidstate.OssmPromWipe.select", "net.shadowkat.minecraft.opensolidstate.OssmPromWipe.assemble", "net.shadowkat.minecraft.opensolidstate.OssmPromWipe.assemble", null, IntArray(0), IntArray(0), emptyList());
		}
		...
		fun assemble(inv: IInventory): Array<Any> {
			...
			ossm_dat.setByteArray("write", ByteArray(0))
			return Array(1) { itm }
		}
	}
}